...
if method == 1:
    ...
    plt.scatter(ec_AB2/10**15, M_AB2, s=3, label = 'EOS ABPR2')
    plt.scatter(ec_AB3/10**15, M_AB3, s=3, label = 'EOS ABPR3')
    plt.scatter(ec_AP/10**15, M_AP, s=3, label = 'EOS APR')
    plt.scatter(ec_B1/10**15, M_B1, s=3, label = 'EOS BBB1')
    plt.scatter(ec_B2/10**15, M_B2, s=3, label = 'EOS BBB2')
    plt.scatter(ec_HL1/10**15, M_HL1, s=3, label = 'EOS HLPS1')
    plt.scatter(ec_HL2/10**15, M_HL2, s=3, label = 'EOS HLPS2')
    plt.scatter(ec_HL3/10**15, M_HL3, s=3, label = 'EOS HLPS3')
    plt.scatter(ec_L/10**15, M_L, s=3, label = 'EOS L')
    plt.xlabel(r'$\varepsilon_c$ [g cm$^{-3}$]$\times 10^{15}$', fontsize='15')
    ...
    ax.set_xlabel(r'$\Omega^2 (R_*^3 / GM_*)$', fontsize='20')
    ax.set_ylabel(r'$GM_*/R_*c^2$', fontsize='20')
...
#############################
    ...
    ax.set_xlabel(r'$\Omega^2 (R_*^3 / GM_*)$', fontsize='15')
    ax.set_ylabel(r'$(M/R)/(M_*/R_*)$', fontsize='15')
    ax.set_zlabel(r'$(R-R_*)/R_*$', fontsize='15')
    plt.gca().invert_yaxis()
    plt.legend(loc='upper left')
...
#############################
    ...
    ax.set_xlabel(r'$\Omega^2 (R_*^3 / GM_*)$', fontsize='20')
    ax.set_ylabel(r'$(M/R)/(M_{M}/R_{M})$', fontsize='20')
    ax.set_zlabel(r'$(R-R_*)/R_*$', fontsize='20')
    plt.gca().invert_xaxis()
#    ax.view_init(azim=145)
    plt.legend(loc='upper left')
